...
public class myedit extends JFrame implements ActionListener
{
	...
	public myedit(PrivateChat a)
	{
		...
		text.getDocument().addDocumentListener(new document());
...
class document implements DocumentListener
{
document(){}
...
privatechat.a1("text~"+encode(text.getText()));
}
}
}
...
public String decode(String s)
{
	...
	while((i=s.indexOf("`%"))!=-1)
	{
    s=new StringBuffer(s).replace(i,i+2,"\n").toString();
	}
    return s;
}
