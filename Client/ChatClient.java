...
public class ChatClient extends Frame implements Serializable,Runnable,KeyListener,ActionListener,CommonSettings {
	...
	{		
		...
		video=new Menu("Extras");
		startvideo=new MenuItem("Chat Media Player");
		...
		startvideo.addActionListener(this);
    ...
    static void renderSplashFrame(Graphics2D g, int frame) {
        final String[] comps = {"The","First", "CrOc", "Video","Audio","Streaming","Messenger","Developed","Purely","in JAVA"};
        g.setComposite(AlphaComposite.Clear);
        g.setPaintMode();
        g.setColor(Color.WHITE);
        //g.drawRect(0,270,475,10);
        g.fillRect(0,260,(288*(int)(Math.random()*10))/10,2);
        //g.drawString(comps[frame],20,40+frame*20);
        //g.fillRect(130,250,280,40);
        /*g.fillRect(130,250,280,40);
        
        g.setPaintMode();
        g.setColor(Color.BLACK);
        g.drawString("Loading...\n"+comps[frame]+"...",0, 270);//[(frame/5)%3]+"...", 130, 260);
	...
	{
		try {//System.out.println("fj"+Message);
			dataoutputstream.writeBytes(Message+"\r\n");	
			//System.out.println("fj"+Message);
	...
	{
		if(evt.getSource().equals(startvideo))
		{	MDIApp mdi = new MDIApp();
		//MediaTest mediatest=new MediaTest(this);
	//Thread tmedia=new Thread(mdi);
	//tmedia.start();
	...
	String UserName,UserRoom,ServerName,AppletStatus,ChatLogo,BannerName,ProxyHost,ServerData,RoomList,SplitString,rtpno="22224";
